...
public class AdocaoService {
    ...
    public ResponseEntity<String> solicitarAdocao(Adocao adocao) {
        int contador = 0;
        ...
        for (Adocao a : adocoes) {
            ...
            } else if (a.getPet() == adocao.getPet() && a.getStatus() == StatusAdocao.AGUARDANDO_AVALIACAO) {
                return ResponseEntity.badRequest().body("Pet já está aguardando avaliação para ser adotado!");
            } else if (a.getTutor() == adocao.getTutor() && a.getStatus() == StatusAdocao.APROVADO) {
                contador += 1;
                if (contador == 5) {
    ...
    public void reprovarAdocao(Adocao adocao) {
